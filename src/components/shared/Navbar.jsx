                            ...
                            <div className="relative group">
                                ...
                                >
                                    <Image
                                        width={40}
                                        height={40}
                                        src={ user?.image || "https://i.pinimg.com/736x/4e/d1/97/4ed197d2f368fbce7e51776504fb8a70.jpg"}
                                        alt="avatar"
                    ...
                    <div className="pt-4 border-t border-border mt-4">
                        {
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <Link href="/dashboard" className="block px-4 py-3 text-base font-medium text-slate-900 hover:bg-slate-50 rounded-xl">
                                    Dashboard
                                </Link>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <Link href="/register">
                                    <Button href="/register" color="primary" className="font-bold rounded-full px-8 bg-gradient-to-r from-amber-400 to-yellow-500 text-white shadow-lg shadow-amber-400/30 hover:scale-105 transition-all duration-300">
                                        Get Started
                                    </Button>
                                </Link>
                            </div>

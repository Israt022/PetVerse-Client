        ...
        <nav className={`sticky top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-white/70 backdrop-blur-md shadow-sm py-2" : "bg-slate-50 py-1"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="hidden md:flex gap-8 items-center">
                    <Link href="/" className="font-medium text-slate-700 hover:text-yellow-600 transition-colors">Home</Link>
                    <Link href="/pets" className="font-medium text-slate-700 hover:text-yellow-600 transition-colors">All Pets</Link>
                </div>
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <Link href="/register">
                        ...
                        <AiOutlineUserAdd className="w-4 h-4" /> Get Started
                        </Button>
                    </Link>
                    </>
                    ...
                    <button className="flex items-center gap-3 p-1 rounded-full hover:bg-muted transition-colors border border-transparent hover:border-border">
                        ...
                        width={40}
                        height={40}
                        src="https://images.unsplash.com/photo-1532170579297-281918c8ae72?q=80&w=884&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        alt="avatar"
                        className="w-10 h-10 rounded-full object-cover ring-2 ring-blue-600/10"
                        />
                        <div className="text-left hidden lg:block">
                        <p className="text-sm font-bold truncate max-w-25">Israt Jahan</p>
                    ...
                    <div className="absolute right-0 top-12 w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl hidden group-hover:flex flex-col py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                        ...
                        <p className="text-xs truncate text-slate-500">israt@gmail.com</p>
                        </div>
            ...
            {isMenuOpen && (
                ...
                <div className="pt-4 border-t border-border mt-4">
                    ...
                    <Link href="/register">
                        <Button href="/register" color="primary" className="font-bold rounded-full px-8 bg-gradient-to-r from-amber-400 to-yellow-500 text-white shadow-lg shadow-amber-400/30 hover:scale-105 transition-all duration-300">Get Started</Button>
                    </Link>
                    </div>
